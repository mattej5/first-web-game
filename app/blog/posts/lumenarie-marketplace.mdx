...
<figure className="mx-auto w-3/5 text-center">
  ...
  />
  <figcaption>
    Teacher Dashboard: balances at a glance, pending approvals, and quick
    actions.
  </figcaption>
</figure>
...
- **Focus:** Students see _exactly_ how to earn, with guardrails like **max 3 Lumens/day** and clear receipts for purchases.
...
<figure className="mx-auto w-3/5 text-center">
  ...
  />
  <figcaption>
    Prize Management: set prices once; tweak as you learn what motivates your
    class.
  </figcaption>
</figure>
...
- Add a _significant_ paragraph to the group’s notes
...
<figure className="mx-auto w-3/5 text-center">
  ...
  />
  <figcaption>
    Goal Submissions: students attach evidence; the teacher approves with one
    click.
  </figcaption>
</figure>
...
Goals are written in plain language and visible on the student dashboard so everyone knows _how_ to win the day.
...
<figure className="mx-auto w-3/5 text-center">
  ...
  />
  <figcaption>
    Class Management: flexible class moves keep rosters aligned with seating and
    schedules.
  </figcaption>
</figure>
