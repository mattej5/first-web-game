...
<figure className="mx-auto w-3/5 text-center">
  ...
  />
  <figcaption>
    Backside of the Seattle temple for the Church of Jesus Christ of Latter-day
    Saints
  </figcaption>
</figure>
...
<figure className="mx-auto w-3/5 text-center">
  ...
  <figcaption className="mt-2 text-sm text-gray-500">
    On top of one of the mountains in Olympic National Park
  </figcaption>
</figure>
...
<figure className="mx-auto w-3/5 text-center">
  ...
  />
  <figcaption className="mt-2 text-sm text-gray-500">
    Vin finds a giant slice of pizza
  </figcaption>
</figure>
...
<figure className="mx-auto w-3/5 text-center">
  ...
  />
  <figcaption className="mt-2 text-sm text-gray-500">
    Entrance to the EY Seattle office
  </figcaption>
</figure>
