...
2. **Auto-place fixed courses.** If a class is _fixed_ (e.g., “IS 402 in Fall only”), stu **locks it** into the correct term automatically.
...
- **Audit-friendly.** Fixed courses and constraints are always visible, so it’s clear _why_ something sits where it does.
...
<figure className="mx-auto w-3/5 text-center">
  ...
  />
  <figcaption>
    Advisors can view graduation plans for students or programs they are
    assigned to.
  </figcaption>
</figure>
...
<figure className="mx-auto w-3/5 text-center">
  ...
  />
  <figcaption>
    Advisors can assign revision suggestions and have the student edit them
    before approving.
  </figcaption>
</figure>
