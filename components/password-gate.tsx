...
export function PasswordGate(
  ...
  return (
    <div
      ...
      className="bg-gradient-to-br from-slate-950 via-slate-900 to-gray-900 border border-gray-700 rounded-2xl p-8 shadow-xl text-gray-100 space-y-6"
    >
      <div>
        <h2
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        <label className="block text-sm font-medium text-gray-300" htmlFor="password-entry">
          Password
        </label>
        <input
          id="password-entry"
          ...
          className="w-full rounded-lg border border-gray-700 bg-gray-950 px-4 py-3 text-base text-white placeholder-gray-500 focus:border-green-400 focus:outline-none focus:ring-2 focus:ring-green-500/40"
          value={inputValue}
